...
<head>
    ...
    <title>Connexion — Veloria House</title>
...
<div class="auth-card">
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mb-3">
            ...
            <input type="email" name="email" class="form-control"
                   value="{{ old('email') }}" placeholder="email@exemple.com" required autofocus>
        </div>
        <div class="mb-3">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            @if(Route::has('password.request'))
                <a href="{{ route('password.request') }}" class="small" style="color:#c9a84c">Mot de passe oublié ?</a>
            @endif
        </div>
    ...
    <p class="text-center text-muted small mb-0">
        ...
        <a href="{{ route('register') }}" style="color:#c9a84c" class="fw-semibold">S'inscrire</a>
    </p>
